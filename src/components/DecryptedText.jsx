...
export default function DecryptedText({
  ...
  const [isDecrypted, setIsDecrypted] = useState(animateOn === 'hover' || animateOn === 'inViewHover');
    ...
    >
      ...
      <span aria-hidden="true">
        {displayText.split('').map((char, index) => {
          ...
          return (
            <span key={index} className={isRevealedOrDone ? className : (encryptedClassName || 'opacity-50')}>
              {char}
            </span>
          );
        })}
